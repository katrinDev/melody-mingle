...
export default function SignUp() {
  ...
  const signUpSubmit: SubmitHandler<RegisterForm> = async (data) => {
    if (Object.keys(errors).length === 0) {
      await userStore.registation(data, snackbarStore);
      ...
      >
        ...
        >
          ...
          >
            ...
            <Stack gap={3}>
              <form noValidate onSubmit={handleSubmit(signUpSubmit)}>
                ...
                <FormControl sx={{ pb: 2 }} required error={!!errors.password}>
